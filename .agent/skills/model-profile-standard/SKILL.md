...
description: Defines the photo style, required assets, profile data structure, and website organization for adding new models to the HUNGER MANAGEMENT agency website
---
